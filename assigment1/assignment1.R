...
# Part 1: Plot Data
# 1.1
## read_data.R script already makes x which is Dtrain$year
plot(Dtrain$year, Dtrain$total)


# Part 3: OLS - Global Linear Trend Model 
# 3.1
...
# 3.4 
## Plot everything with prediction intervals
...
# 3.5: Is it a good forecast? Comments:
...
# Part 4: WLS - Local Linear Trend Model
